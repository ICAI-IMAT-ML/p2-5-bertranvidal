...
class LogisticRegressor:
    ...
    def fit(
        ...
        self.weights = np.zeros(n)# n es el número de características en X
        self.bias = 0  # El bias es un escalar
    ...
    def elasticnet_regularization(self, dw, m, C, l1_ratio):
        ...
        l1_component = (C / m) * l1_ratio * np.sign(self.weights)

        # Contribución de L2 (Ridge)
        l2_component = (C / m) * (1 - l1_ratio) * self.weights

        # Suma de ambas contribuciones
        elasticnet_gradient = l1_component + l2_component
